...
void loop()
{
    ...
    Serial1.print("agx:");Serial1.print(agx);Serial1.print(",");
    Serial1.print("agy:");Serial1.print(agy);Serial1.print(",");
    Serial1.print("agz:");Serial1.print(agz); Serial1.print(",");
    Serial1.print("ax:");Serial1.print(gx);Serial1.print(",");
    Serial1.print("gy:");Serial1.print(gy);Serial1.print(",");
